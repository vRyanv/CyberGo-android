...
public class FieldName {
    //map
    public final static String TRIP_SHARING = "trip_sharing";
    ...
    public final static String BACK_ID_CARD = "back_id_card";
    ...
    public final static String FRONT_DRIVING_LICENSE = "front_driving_license";
